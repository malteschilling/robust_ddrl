...
from small_env.ant_multienv import AntReducedMultiEnv
        
class AntReducedCentralizedEnv(AntReducedMultiEnv):
    ...
    def __init__(self, config):
        ...
        self.obs_indices["central_policy"] =  range(0,27)
    ...
    def policy_mapping_fn(agent_id):
        ...
        return AntReducedCentralizedEnv.policy_names[0]
            
    @staticmethod
    def return_policies():
        # For each agent the policy interface has to be defined.
        policies = {
            AntReducedCentralizedEnv.policy_names[0]: (None,
                spaces.Box(-np.inf, np.inf, (27,), np.float64), 
