...
class AntCentralizedEnv(AntMultiEnv):
    ...
    def __init__(self, config):
        ...
        self.obs_indices["central_policy"] =  range(0,111)
    ...
    def policy_mapping_fn(agent_id):
        ...
        return AntCentralizedEnv.policy_names[0]
            
    @staticmethod
    def return_policies():
        # For each agent the policy interface has to be defined.
        policies = {
            AntCentralizedEnv.policy_names[0]: (None,
